...
public class DigitalDAOImpl extends DBContext implements DigitalDAO {
     ...
     *
     * @param number the number of Digital want get. It is a integer number
     ...
     * author, timePost, shortDes
     *
     * @param id the id of a digital. It is a number which has type int
